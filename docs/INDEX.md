...
- retained refs 第七波吸收审计：`docs/audits/2026-04-13-l0-retained-refs-seventh-absorption-audit.md`
...
- 当前 retained-refs latest absorption 入口固定为 `docs/audits/2026-04-13-l0-retained-refs-seventh-absorption-audit.md`。
