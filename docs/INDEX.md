...
- retained refs 第六波吸收审计：`docs/audits/2026-04-13-l0-retained-refs-sixth-absorption-audit.md`
...
- 当前 retained-refs latest absorption 入口固定为 `docs/audits/2026-04-13-l0-retained-refs-sixth-absorption-audit.md`。
...
- 第六波之后，`--details` 还会额外给出 `next_focus=`，并把 tests drift 继续拆成 real test source、runtime records、control files、output artifacts 和 binary artifacts。
