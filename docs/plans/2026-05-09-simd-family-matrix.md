...
| `AES`     | no stable adapter target          | `src/fafafa.core.simd.intrinsics.aes.pas`                                                  | `experimental isolated`                  | `experimental-intrinsics` isolation only                                                                                                                                    | no             | no                               | Wave 4 hold          | 继续 hold；具体 reopen 触发条件看 `simd-experimental-hold-future-trigger-plan` 的 `AES` 行             |
| `SHA`     | no stable adapter target          | `src/fafafa.core.simd.intrinsics.sha.pas`                                                  | `experimental isolated`                  | `experimental-intrinsics` isolation only                                                                                                                                    | no             | no                               | Wave 4 hold          | 继续 hold；具体 reopen 触发条件看 `simd-experimental-hold-future-trigger-plan` 的 `SHA` 行             |
| `AVX`     | no stable adapter target          | `src/fafafa.core.simd.intrinsics.avx.pas`                                                  | `experimental isolated`                  | `experimental-intrinsics` isolation only                                                                                                                                    | no             | no                               | Wave 4 hold          | 继续 hold；具体 reopen 触发条件看 `simd-experimental-hold-future-trigger-plan` 的 `AVX` 行             |
