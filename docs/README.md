...
- Linux x64 的日常维护入口固定为：`bash tests/run_strict_l0_maintenance_loop.sh`；它会串起 docs consistency、active shell runners、examples/build current-entry contract、gate、`git diff --check`、runtime matrix 和 native closeout stack
