...
- Local main head: `ec2a023484fde0831e394d9468edd6a1a548e0b4` (`main`)
- Remote main head: `4a5b696ca2ab6a09d6d918aab021d0c543be9bbe` (`origin/main`)
- Current HEAD: `4a5b696ca2ab6a09d6d918aab021d0c543be9bbe`
- Latest merged-main exact evidence head: `ef83a697b6c6efec424a75f8495c79d675770f1a`
- Current focus:
  ...
  - 保持 merged-main current-state 文档显式写清：latest exact Windows native evidence 仍锚定 `main@ef83a697b6c6efec424a75f8495c79d675770f1a`；当前 active L0 worktree head `4a5b696ca2ab6a09d6d918aab021d0c543be9bbe` 与 `origin/main@4a5b696ca2ab6a09d6d918aab021d0c543be9bbe` 一致，而 root `main@ec2a023484fde0831e394d9468edd6a1a548e0b4` 仍需单独记录，避免把 root 工作区状态混写成当前 L0 lane。
...
- `bash tests/test_strict_l0_retained_refs_sidecar_hygiene_contract.sh`
  ...
  - 结果：PASS；head sha=`ef83a697b6c6efec424a75f8495c79d675770f1a`
