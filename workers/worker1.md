...
- Base commit: `a25acfe4f56bfd021e860aabe09e3cc392ef01ab` (`main`)
- Remote main head: `ef83a697b6c6efec424a75f8495c79d675770f1a` (`origin/main`)
- Current HEAD: `ef83a697b6c6efec424a75f8495c79d675770f1a`
...
- Current focus:
  ...
  - 保持 merged-main current-state 文档显式写清：latest exact Windows native evidence 仍锚定 `main@ef83a697b6c6efec424a75f8495c79d675770f1a`；并把当前本地 `main@a25acfe4f56bfd021e860aabe09e3cc392ef01ab`、`origin/main@ef83a697b6c6efec424a75f8495c79d675770f1a` 与当前 worktree head `ef83a697b6c6efec424a75f8495c79d675770f1a` 明确区分，避免把未合并 L0 增量误写成已经进 main。
