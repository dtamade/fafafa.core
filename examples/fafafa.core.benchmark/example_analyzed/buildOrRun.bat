...
set LPI=%EXAMPLE_DIR%example_analyzed.lpi
...
if not exist "%LPI%" (
  ...
  >>"%LPI%" echo     ^<General^>
  >>"%LPI%" echo       ^<Title Value="example_analyzed"/^>
  ...
  >>"%LPI%" echo           ^<Target^>
  >>"%LPI%" echo             ^<Filename Value=".\bin\example_analyzed"/^>
  >>"%LPI%" echo           ^</Target^>
  ...
  >>"%LPI%" echo     ^<Units^>
  >>"%LPI%" echo       ^<Unit^>
  >>"%LPI%" echo         ^<Filename Value="example_analyzed.lpr"/^>
