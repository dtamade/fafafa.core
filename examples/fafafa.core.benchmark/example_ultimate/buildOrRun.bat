...
set LPI=%EXAMPLE_DIR%example_ultimate.lpi
...
if not exist "%LPI%" (
  ...
  >>"%LPI%" echo     ^<General^>
  >>"%LPI%" echo       ^<Title Value="example_ultimate"/^>
  ...
  >>"%LPI%" echo           ^<Target^>
  >>"%LPI%" echo             ^<Filename Value=".\bin\example_ultimate"/^>
  >>"%LPI%" echo           ^</Target^>
  ...
  >>"%LPI%" echo     ^<Units^>
  >>"%LPI%" echo       ^<Unit^>
  >>"%LPI%" echo         ^<Filename Value="example_ultimate.lpr"/^>
