...
set "PROJECT=example_security_showcase.lpi"
set "EXE=bin\example_security_showcase.exe"
...
if %errorlevel%==0 (
  ...
  fpc -Mobjfpc -Sh -O1 -g -gl -gh -Ci -Co -Cr -Ct -I../../src -Fu../../src -Fu. -FUlib -FEbin example_security_showcase.lpr
  if %ERRORLEVEL% NEQ 0 (
