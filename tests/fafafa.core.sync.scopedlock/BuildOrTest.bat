...
set "PROJECT=fafafa.core.sync.scopedlock.test.lpi"
set "TEST_EXECUTABLE=bin\fafafa.core.sync.scopedlock.test"
set "TEST_EXECUTABLE_ALT=bin\fafafa.core.sync.scopedlock.test.exe"
