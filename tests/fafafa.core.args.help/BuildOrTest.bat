...
set "PROJECT=fafafa.core.args.help.test.lpi"
set "TEST_EXECUTABLE=bin\fafafa.core.args.help.test"
set "TEST_EXECUTABLE_ALT=bin\fafafa.core.args.help.test.exe"
