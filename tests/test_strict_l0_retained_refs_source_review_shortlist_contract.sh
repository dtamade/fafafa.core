...
for LPatt in \
  ...
  'sample_review_candidate_paths=src/fafafa.core.atomic.pas | tests/fafafa.core.atomic/Test_fafafa.core.atomic.pas | tests/fafafa.core.platform/BuildOrTest.sh' \
  ...
  'review_candidate_paths=5' \
  'src_review_paths=1' \
  'test_code_review_paths=1' \
  'test_script_review_paths=1' \
  'test_doc_review_paths=1' \
  'ci_review_paths=0' \
