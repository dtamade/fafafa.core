...
set "PROJECT=fafafa.core.bits.test.lpi"
set "TEST_EXECUTABLE=bin\fafafa.core.bits.test"
set "TEST_EXECUTABLE_ALT=bin\fafafa.core.bits.test.exe"
set "CLEAN_DIRS=lib bin logs"
set "LAZBUILD=..\..\tools\lazbuild.bat"
set "SRC_WARN_PATTERNS=/C:\"src/.*fafafa.core.bits.*Warning:\" /C:\"src/.*fafafa.core.bits.*Hint:\" /C:\"\src\.*fafafa.core.bits.*Warning:\" /C:\"\src\.*fafafa.core.bits.*Hint:\""
