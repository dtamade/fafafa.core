...
set "PROJECT=fafafa.core.mem.allocator.foundation.test.lpi"
set "TEST_EXECUTABLE=bin\fafafa.core.mem.allocator.foundation.test_debug"
set "TEST_EXECUTABLE_ALT=bin\fafafa.core.mem.allocator.foundation.test_debug.exe"
set "TEST_EXECUTABLE_FALLBACK=bin\fafafa.core.mem.allocator.foundation.test"
set "TEST_EXECUTABLE_FALLBACK_ALT=bin\fafafa.core.mem.allocator.foundation.test.exe"
set "CLEAN_DIRS=lib bin logs"
set "LAZBUILD=..\..\tools\lazbuild.bat"
set "SRC_WARN_PATTERNS=/C:\"src/.*fafafa.core.mem.allocator.foundation.*Warning:\" /C:\"src/.*fafafa.core.mem.allocator.foundation.*Hint:\" /C:\"src/.*fafafa.core.mem.allocator.base.*Warning:\" /C:\"src/.*fafafa.core.mem.allocator.base.*Hint:\" /C:\"src/.*fafafa.core.mem.allocator.rtlAllocator.*Warning:\" /C:\"src/.*fafafa.core.mem.allocator.rtlAllocator.*Hint:\" /C:\"src/.*fafafa.core.mem.allocator.callbackAllocator.*Warning:\" /C:\"src/.*fafafa.core.mem.allocator.callbackAllocator.*Hint:\" /C:\"\src\.*fafafa.core.mem.allocator.foundation.*Warning:\" /C:\"\src\.*fafafa.core.mem.allocator.foundation.*Hint:\" /C:\"\src\.*fafafa.core.mem.allocator.base.*Warning:\" /C:\"\src\.*fafafa.core.mem.allocator.base.*Hint:\" /C:\"\src\.*fafafa.core.mem.allocator.rtlAllocator.*Warning:\" /C:\"\src\.*fafafa.core.mem.allocator.rtlAllocator.*Hint:\" /C:\"\src\.*fafafa.core.mem.allocator.callbackAllocator.*Warning:\" /C:\"\src\.*fafafa.core.mem.allocator.callbackAllocator.*Hint:\""
set "BUILD_MODE=Debug"

if /i "%ACTION%"=="build-no-contracts" (
  set "BUILD_MODE=NoContracts"
  set "TEST_EXECUTABLE=bin\fafafa.core.mem.allocator.foundation.test_nocontracts"
  set "TEST_EXECUTABLE_ALT=bin\fafafa.core.mem.allocator.foundation.test_nocontracts.exe"
)
...
if /i not "%ACTION%"=="test" if /i not "%ACTION%"=="test-no-contracts" (
  echo Usage: %~nx0 [build^|check^|test^|build-no-contracts^|check-no-contracts^|test-no-contracts^|clean^|rebuild]
  set "EXIT_ERR=2"
  goto :END
)
