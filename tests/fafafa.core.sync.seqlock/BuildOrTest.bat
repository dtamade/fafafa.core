...
set "PROJECT=fafafa.core.sync.seqlock.test.lpi"
set "TEST_EXECUTABLE=bin\fafafa.core.sync.seqlock.test"
set "TEST_EXECUTABLE_ALT=bin\fafafa.core.sync.seqlock.test.exe"
