program fafafa.core.sync.namedConditionVariable.test;
...
uses
  ...
  fafafa.core.sync.namedConditionVariable.testcase;

var
  LResult: TTestResult;
  
begin
  WriteLn('fafafa.core.sync.namedConditionVariable 单元测试');
  WriteLn('================================================');
