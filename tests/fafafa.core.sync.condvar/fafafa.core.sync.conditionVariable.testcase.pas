...
uses
  ...
  fafafa.core.sync.base, fafafa.core.sync.mutex, fafafa.core.sync.condvar;
...
Type
  ...
  public
constructor TWaiterThread.Create(const ACond: ICondVar; const ALock: ILock; AFlag: PBoolean; AIterations: Integer = 1);
  end;
...
constructor TWaiterThread.Create(const ACond: ICondVar;
begin
