...
set "PROJECT=fafafa.core.endian.test.lpi"
set "TEST_EXECUTABLE=bin\fafafa.core.endian.test"
set "TEST_EXECUTABLE_ALT=bin\fafafa.core.endian.test.exe"
set "CLEAN_DIRS=lib bin logs"
set "LAZBUILD=..\..\tools\lazbuild.bat"
set "SRC_WARN_PATTERNS=/C:\"src/.*fafafa.core.endian.*Warning:\" /C:\"src/.*fafafa.core.endian.*Hint:\" /C:\"\src\.*fafafa.core.endian.*Warning:\" /C:\"\src\.*fafafa.core.endian.*Hint:\""
