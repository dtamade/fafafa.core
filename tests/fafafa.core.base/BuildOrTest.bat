...
set "PROJECT=fafafa.core.base.test.lpi"
set "TEST_EXECUTABLE=bin\fafafa.core.base.test"
set "TEST_EXECUTABLE_ALT=bin\fafafa.core.base.test.exe"
set "CLEAN_DIRS=lib bin logs"
set "LAZBUILD=..\..\tools\lazbuild.bat"
set "SRC_WARN_PATTERNS=/C:\"src/.*fafafa.core.base.*Warning:\" /C:\"src/.*fafafa.core.base.*Hint:\" /C:\"\src\.*fafafa.core.base.*Warning:\" /C:\"\src\.*fafafa.core.base.*Hint:\""
