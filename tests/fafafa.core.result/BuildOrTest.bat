...
set "PROJECT=fafafa.core.result.test.lpi"
set "TEST_EXECUTABLE=bin\fafafa.core.result.test"
set "TEST_EXECUTABLE_ALT=bin\fafafa.core.result.test.exe"
set "CLEAN_DIRS=lib bin logs"
set "LAZBUILD=..\..\tools\lazbuild.bat"
set "SRC_WARN_PATTERNS=/C:\"src/.*fafafa.core.result.*Warning:\" /C:\"src/.*fafafa.core.result.*Hint:\" /C:\"\src\.*fafafa.core.result.*Warning:\" /C:\"\src\.*fafafa.core.result.*Hint:\""
