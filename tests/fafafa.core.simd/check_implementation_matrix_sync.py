...
IMPLEMENTATION_MATRIX_FILE = REPO_ROOT / "docs" / "fafafa.core.simd.implementation-matrix.md"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Fail-close sync check for docs/fafafa.core.simd.implementation-matrix.md"
    )
