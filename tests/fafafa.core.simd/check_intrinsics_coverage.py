...
def parse_args() -> argparse.Namespace:
    l_parser = argparse.ArgumentParser(
        description=(
            ...
            "and the SSE2 raw-leaf experimental surface."
        )
    )
...
def build_module_configs(a_repo_root: Path, a_args: argparse.Namespace) -> list[ModuleConfig]:
    return [
        ModuleConfig(
            ...
            required=True,
            src=a_repo_root / "src" / "fafafa.core.simd.intrinsics.sse.pas",
            test=a_repo_root / "tests" / "fafafa.core.simd.intrinsics.sse" / "fafafa.core.simd.intrinsics.sse.testcase.pas",
        ),
        ModuleConfig(
            name="mmx",
            prefix="mmx",
            test_mode="suite_name",
            required=True,
            src=a_repo_root / "src" / "fafafa.core.simd.intrinsics.mmx.pas",
            test=a_repo_root / "tests" / "fafafa.core.simd.intrinsics.mmx" / "fafafa.core.simd.intrinsics.mmx.testcase.pas",
        ),
        ModuleConfig(
            name="avx2",
            prefix="avx2",
            ...
            src=a_repo_root / "src" / "fafafa.core.simd.intrinsics.avx2.pas",
            test=a_repo_root / "tests" / "fafafa.core.simd" / "fafafa.core.simd.intrinsics.avx2.testcase.pas",
        ),
        ModuleConfig(
            name="aes",
            prefix="aes",
            ...
            src=a_repo_root / "src" / "fafafa.core.simd.intrinsics.aes.pas",
        ...
        ModuleConfig(
            ...
            test_mode="symbol_ref",
            required=a_args.require_experimental,
            src=a_repo_root / "src" / "fafafa.core.simd.intrinsics.sha.pas",
            test=a_repo_root / "tests" / "fafafa.core.simd.intrinsics.experimental" / "fafafa.core.simd.intrinsics.experimental.testcase.pas",
        ),
        ModuleConfig(
            name="sse2-x86-raw",
