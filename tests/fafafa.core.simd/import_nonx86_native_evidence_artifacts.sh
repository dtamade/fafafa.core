...
- tests/fafafa.core.simd/fixtures/native-evidence
...
- an already imported directory under tests/fafafa.core.simd/fixtures/native-evidence (import becomes a verify-only no-op)
