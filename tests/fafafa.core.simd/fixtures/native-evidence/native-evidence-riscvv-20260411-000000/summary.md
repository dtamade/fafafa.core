...
- Root: /tmp/fafafa.core
- Host Arch: riscv64
- Backend: RISCVV
- Output Root: /tmp/riscvv/run
- Environment: /home/dtamade/projects/fafafa.core/tests/fafafa.core.simd/fixtures/native-evidence/native-evidence-riscvv-20260411-000000/environment.txt

## list-suites
[BUILD] OK
[TEST] Running: /tmp/riscvv/run/bin2/fafafa.core.simd.test --list-suites
[TEST] OK
[LEAK] OK

## DispatchAPI + PublicAbi
[BUILD] OK
[TEST] Running: /tmp/riscvv/run/bin2/fafafa.core.simd.test --suite=TTestCase_DispatchAPI,TTestCase_PublicAbi
[TEST] OK
[LEAK] OK

## Runtime Parity (TTestCase_NonX86BackendParity,TTestCase_DataPlane)
[BUILD] OK
[TEST] Running: /tmp/riscvv/run/bin2/fafafa.core.simd.test --suite=TTestCase_NonX86BackendParity,TTestCase_DataPlane
[TEST] OK
[LEAK] OK
...
[BUILD] OK
[TEST] Running: /tmp/riscvv/run/bin2/fafafa.core.simd.test --suite=TTestCase_DispatchAPI,TTestCase_DirectDispatch,TTestCase_DataPlane
[TEST] OK
[LEAK] OK
