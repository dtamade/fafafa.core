...
SIMD_PAS_GLOB = "fafafa.core.simd*.pas"
SIMD_INC_GLOB = "fafafa.core.simd*.inc"
EXPERIMENTAL_UNIT_PREFIX = "fafafa.core.simd.intrinsics"

ALLOWED_UNREACHABLE_INCLUDES = {
    "fafafa.core.simd.neon.scalar.wide_memory.inc": (
...
def build_result() -> dict[str, Any]:
    ...
    def queue_include(a_owner: str, a_include_name: str) -> None:
        if a_include_name in l_include_files:
            ...
            return
        if a_include_name.startswith("fafafa.core.simd"):
