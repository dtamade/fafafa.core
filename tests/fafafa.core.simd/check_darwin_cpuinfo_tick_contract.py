...
CPUINFO_LAZY_FILE = ROOT / "src" / "fafafa.core.simd.cpuinfo.lazy.pas"
DARWIN_TICK_FILE = ROOT / "src" / "fafafa.core.time.tick.darwin.pas"
...
DARWIN_TICK_FORBIDDEN_PATTERNS = (
    (
        ...
        "Darwin tick must not depend on fafafa.core.time.tick.unix",
    ),
)
