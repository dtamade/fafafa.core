...
TIME_CPU_FILE = ROOT / "src" / "fafafa.core.time.cpu.pas"
CPUINFO_DIAGNOSTIC_FILE = ROOT / "src" / "fafafa.core.simd.cpuinfo.diagnostic.pas"
DARWIN_SMOKE_SCRIPT = ROOT / "tests" / "fafafa.core.simd" / "compile_darwin_smoke_via_osxcross.sh"
DARWIN_LINK_SMOKE_FILE = ROOT / "tests" / "fafafa.core.simd" / "fafafa.core.simd.darwin_link_smoke.pas"
DARWIN_CPUINFO_LINK_SMOKE_FILE = (
    ROOT
    / "tests"
    / "fafafa.core.simd.cpuinfo"
    / "fafafa.core.simd.cpuinfo.darwin_link_smoke.pas"
)
