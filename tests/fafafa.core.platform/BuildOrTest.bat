...
set "PROJECT=fafafa.core.platform.test.lpi"
set "TEST_EXECUTABLE=bin\fafafa.core.platform.test"
set "TEST_EXECUTABLE_ALT=bin\fafafa.core.platform.test.exe"
set "CLEAN_DIRS=lib bin logs"
set "LAZBUILD=..\..\tools\lazbuild.bat"
set "SRC_WARN_PATTERNS=/C:\"src/.*fafafa.core.platform.*Warning:\" /C:\"src/.*fafafa.core.platform.*Hint:\" /C:\"\src\.*fafafa.core.platform.*Warning:\" /C:\"\src\.*fafafa.core.platform.*Hint:\""
