...
4. `tests/fafafa.core.span/BuildOrTest.sh`
5. `tests/fafafa.core.span/BuildOrTest.bat`
6. `tests/fafafa.core.span/fafafa.core.span.test.lpi`
7. `tests/fafafa.core.span/fafafa.core.span.testcase.pas`
