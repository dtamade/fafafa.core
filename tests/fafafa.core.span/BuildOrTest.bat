...
set "PROJECT=fafafa.core.span.test.lpi"
set "TEST_EXECUTABLE=bin\fafafa.core.span.test"
set "TEST_EXECUTABLE_ALT=bin\fafafa.core.span.test.exe"
set "CLEAN_DIRS=lib bin logs"
set "LAZBUILD=..\..\tools\lazbuild.bat"
set "SRC_WARN_PATTERNS=/C:\"src/.*fafafa.core.span.*Warning:\" /C:\"src/.*fafafa.core.span.*Hint:\" /C:\"\src\.*fafafa.core.span.*Warning:\" /C:\"\src\.*fafafa.core.span.*Hint:\""
