...
set "PROJECT=fafafa.core.layout.test.lpi"
set "TEST_EXECUTABLE=bin\fafafa.core.layout.test"
set "TEST_EXECUTABLE_ALT=bin\fafafa.core.layout.test.exe"
set "CLEAN_DIRS=lib bin logs"
set "LAZBUILD=..\..\tools\lazbuild.bat"
set "SRC_WARN_PATTERNS=/C:\"src/.*fafafa.core.layout.*Warning:\" /C:\"src/.*fafafa.core.layout.*Hint:\" /C:\"\src\.*fafafa.core.layout.*Warning:\" /C:\"\src\.*fafafa.core.layout.*Hint:\""
