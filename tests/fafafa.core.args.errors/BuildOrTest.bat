...
set "PROJECT=fafafa.core.args.errors.test.lpi"
set "TEST_EXECUTABLE=bin\fafafa.core.args.errors.test"
set "TEST_EXECUTABLE_ALT=bin\fafafa.core.args.errors.test.exe"
