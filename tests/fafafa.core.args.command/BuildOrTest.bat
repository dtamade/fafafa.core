...
set "PROJECT=fafafa.core.args.command.test.lpi"
set "TEST_EXECUTABLE=bin\fafafa.core.args.command.test"
set "TEST_EXECUTABLE_ALT=bin\fafafa.core.args.command.test.exe"
