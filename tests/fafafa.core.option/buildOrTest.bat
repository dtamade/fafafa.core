...
set "TEST_EXECUTABLE=bin\fafafa.core.option.test"
set "TEST_EXECUTABLE_ALT=bin\fafafa.core.option.test.exe"
set "CLEAN_DIRS=lib bin logs"
set "LAZBUILD=..\..\tools\lazbuild.bat"
set "SRC_WARN_PATTERNS=/C:\"src/.*fafafa.core.option.*Warning:\" /C:\"src/.*fafafa.core.option.*Hint:\" /C:\"\src\.*fafafa.core.option.*Warning:\" /C:\"\src\.*fafafa.core.option.*Hint:\""
