...
set "PROJECT=fafafa.core.args.base.test.lpi"
set "TEST_EXECUTABLE=bin\fafafa.core.args.base.test"
set "TEST_EXECUTABLE_ALT=bin\fafafa.core.args.base.test.exe"
