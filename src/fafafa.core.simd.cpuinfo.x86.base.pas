...
{ x86 共用辅助：
  ...
  - 架构相关的 CPUID/XGETBV 由 .x86.i386/.x86.x86_64 提供
}

// 预留：根据 XCR0 判断 AVX/AVX-512 OS 支持
function XCR0HasAVX(xcr0: UInt64): Boolean; inline;
function XCR0HasAVX512(xcr0: UInt64): Boolean; inline;

implementation

function XCR0HasAVX(xcr0: UInt64): Boolean;
begin
  Result := (xcr0 and $06) = $06;
end;

function XCR0HasAVX512(xcr0: UInt64): Boolean;
begin
